---
title: "EE vs ENE Models: Model 7"
date: "`r Sys.Date()`"
...
```{r, eval = TRUE}
tbl_regression(model_7, intercept = TRUE, 
  ...
  as_gt() #%>%
  # gt::gtsave(., filename = "D:/PATHWEIGH/delivery_20240917/scripts/ee_vs_ene/ee_vs_ene_models/model_7.docx" )
```
...
obs_pred <- bind_cols(
  data,
  tibble(predicted = predict(model_7, data, type = "response"))
  ) %>%
  mutate(
    observed = Weight_dv
  )
