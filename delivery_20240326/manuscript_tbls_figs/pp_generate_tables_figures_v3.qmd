...
```{r, fig.height = 4.2, fig.width=6.5, fig.dpi = 600}
# This labelling function was added to change "Int_PW" Int_nPW facet labels
face_names <- as_labeller(
  c(`Con_nPW` = "C",
    `Con_PW` = "D",
    `Int_nPW` = "E",
...
Number of patients with at least one follow up visit in a single phase. Values are not mutually exclusive because the same patient could be counted twice, once for each phase.
```{r}
ee %>%
