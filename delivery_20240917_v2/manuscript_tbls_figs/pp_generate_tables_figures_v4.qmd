---
title: "PP Tables & Figures Aim1a v2"
format: 
  docx:
...
proj_parent_dir <- str_remove(here::here(), proj_root_dir)
...
load(
  here::here(proj_parent_dir, proj_root_dir, "data", str_c("pp_data_", delivery, ".Rdata"))
)
...
# Load visits_post_id
load(
  here::here(proj_parent_dir, proj_root_dir, "data", str_c("visits_post_id_", delivery, ".Rdata"))
)
...
load(
  here::here(proj_parent_dir, proj_root_dir, "data", str_c("pp_mod_data_", delivery, ".Rdata"))
)
...
comorbidity_names <- readRDS("D:\\PATHWEIGH\\delivery_20240917_v2\\data\\comorbidity_names_20240917.RDS")
```
